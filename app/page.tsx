  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Discover the Magic of Kenya</h1>
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Experience unforgettable adventures with Kenya's most trusted tour operator. From the Maasai Mara to
              pristine beaches, we make your dream safari come true.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Tailored experiences that showcase the best of Kenya's wildlife, culture, and natural beauty
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="text-blue-900">Safari Adventures</CardTitle>
                <CardDescription>
                  Witness the Big Five in their natural habitat across Kenya's world-famous national parks
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Relax on pristine white sand beaches along Kenya's stunning Indian Ocean coastline
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm text-gray-600 mb-4">
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Immerse yourself in Kenya's rich cultural heritage and meet local communities
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm text-gray-600 mb-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-2">
                  <h3 className="text-xl font-bold text-gray-900">Maasai Mara</h3>
                  <Badge className="bg-blue-100 text-blue-800">Popular</Badge>
                </div>
                <p className="text-gray-600 mb-4">
                  Home to the Great Migration and abundant wildlife. Experience the ultimate safari adventure.
                </p>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-2">
                  <h3 className="text-xl font-bold text-gray-900">Diani Beach</h3>
                  <Badge className="bg-green-100 text-green-800">Relaxing</Badge>
                </div>
                <p className="text-gray-600 mb-4">
                  Pristine white sand beaches perfect for relaxation and water sports activities.
                </p>
                <Button variant="outline" className="w-full bg-transparent" asChild>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-2">
                  <h3 className="text-xl font-bold text-gray-900">Mount Kenya</h3>
                  <Badge className="bg-orange-100 text-orange-800">Adventure</Badge>
                </div>
                <p className="text-gray-600 mb-4">
                  Africa's second-highest peak offering challenging climbs and stunning alpine scenery.
                </p>
                <Button variant="outline" className="w-full bg-transparent" asChild>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Why Choose Flufftails Tours?</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Our experienced guides know Kenya inside out and share fascinating insights about wildlife and culture.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Customized Itineraries</h3>
              <p className="text-gray-600">
                Every tour is tailored to your preferences, ensuring a unique and personalized experience.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Small Group Tours</h3>
              <p className="text-gray-600">
                Intimate group sizes ensure personal attention and a more authentic travel experience.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready for Your Kenyan Adventure?</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Don't wait! Book your dream safari today and create memories that will last a lifetime.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-white text-blue-600 hover:bg-gray-100" asChild>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-2xl font-bold text-blue-400 mb-4">FLUFFTAILS</h3>
              <p className="text-gray-300 mb-4">TOURS & TRAVEL</p>
              <p className="text-gray-400">
                Your trusted partner for unforgettable Kenyan adventures. Experience the magic of Kenya with us.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-gray-400">info@flufftailstours.com</span>
                </div>
                <div className="flex items-center">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p className="text-gray-400">© 2024 Flufftails Tours & Travel. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
